...
const EditTask = () => {
    ...
    const handleEdit = async () => {
        const [code, title, employee_id, status_id] = [codeInput, titleInput, selectedEmployee, selectedStatus]
        ...
        const response = await editTask(+task_id, { code, title, description, due_date, employee_id, status_id })
