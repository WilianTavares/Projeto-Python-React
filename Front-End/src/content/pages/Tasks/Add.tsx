...
const AddTask = () => {
    ...
    const handleAdd = async () => {
        const [code, title, description, employee_id, status_id] = [codeInput, titleInput, descriptionInput, selectedEmployee, selectedStatus]
        ...
        const response = await addTask({ code, title, description, due_date, employee_id, status_id })
